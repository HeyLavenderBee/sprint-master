...
async function obterDados() {
   ...
   try {
    ...
    const tentativasRestantes2 = document.getElementById("tentativas-restantes-2");
    ...
    const tentativasRestantes3 = document.getElementById("tentativas-restantes-3");
    ...
    const tentativasRestantes4 = document.getElementById("tentativas-restantes-4");
    ...
    const tentativasRestantes5 = document.getElementById("tentativas-restantes-5");
